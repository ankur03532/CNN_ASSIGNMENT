...
- Model 3: Final model showing promising results with good accuracy and validation accuracy. Augmentor library has been used to increase the sample data since there was data imbalance.
